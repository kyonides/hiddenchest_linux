...
public:
  ...
  int triggered_kind(int n);
  int triggered_js_value(int n);
  int triggered_js_axis(int n);
  int triggered_js_dir(int n);
  int triggered_last(int n);
  int triggered_old(int n);
  void triggered_last_clear(int n);
  int dir4Value();
  int dir8Value();
  bool is_dir4();
  bool is_dir8();
