...
static VALUE settings_click_timer_get(VALUE self)
{
  return rb_iv_get(self, "@click_timer");
}

static VALUE settings_click_timer_set(VALUE self, VALUE frames)
{
...
void init_settings()
{
  ...
  rb_define_module_function(set, "click_timer", RMF(settings_click_timer_get), 0);
  rb_define_module_function(set, "click_timer=", RMF(settings_click_timer_set), 1);
}
