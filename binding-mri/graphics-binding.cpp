...
void graphicsBindingInit()
{
  ...
  rb_define_module_function(module, "snap_to_gray_bitmap", RMF(graphics_snap2gray_bitmap), 0);
  rb_define_module_function(module, "snap_to_sepia_bitmap", RMF(graphics_snap2sepia_bitmap), 0);
  rb_define_module_function(module, "snap_to_color_bitmap", RMF(graphics_snap2color_bitmap), 1);
  ...
  rb_define_module_function(module, "screenshot", RMF(graphics_save_screenshot), 0);
